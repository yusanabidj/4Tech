...
mysqli_query($koneksi, "update produk set produk_nama='$nama', produk_kategori='$kategori', produk_harga='$harga', produk_keterangan='$keterangan', produk_jumlah='$jumlah' where produk_id='$id'");
